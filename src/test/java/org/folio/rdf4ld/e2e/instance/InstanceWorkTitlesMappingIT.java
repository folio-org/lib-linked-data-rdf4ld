...
class InstanceWorkTitlesMappingIT {
  ...
  void mapBibframe2RdfToLd_shouldReturnMappedInstanceWithWorkWithTitles() throws IOException {
    // given
    var input = this.getClass().getResourceAsStream("/rdf/instance/work/instance_work_titles.json");
  ...
  void mapLdToBibframe2Rdf_shouldReturnMappedRdfInstanceWithTitles() throws IOException {
    ...
    var inputStream = this.getClass().getResourceAsStream("/rdf/instance/work/instance_work_titles.json");
