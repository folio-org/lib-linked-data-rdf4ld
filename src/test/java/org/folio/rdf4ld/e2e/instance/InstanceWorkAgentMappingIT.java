...
class InstanceWorkAgentMappingIT {
  ...
  private static final String BASE_PATH = "/rdf/instance/work/agent/";
  ...
  void mapBibframe2RdfToLd_shouldReturnMappedInstanceWithWorkWithAgentMocks() throws IOException {
    // given
    var input = this.getClass().getResourceAsStream(BASE_PATH + "instance_work_agent_lccn.json");
  ...
  void mapBibframe2RdfToLd_shouldReturnMappedInstanceWithWorkWithAgents_withLccnWithBodies() throws IOException {
    // given
    var input = this.getClass().getResourceAsStream(BASE_PATH + "instance_work_agent_lccn_with_body.json");
    var model = Rio.parse(input, "", RDFFormat.JSONLD);
  ...
  void mapBibframe2RdfToLd_shouldMapRdfsLabelToNameAndAuthoritativeLabelToLabel() throws IOException {
    // given
    var input = this.getClass().getResourceAsStream(BASE_PATH + "instance_work_agent_label_name_distinction.json");
    var model = Rio.parse(input, "", RDFFormat.JSONLD);
  ...
  void mapBibframe2RdfToLd_shouldReturnMappedInstanceWithWorkWithAgents_withNoCurrentLccn() throws IOException {
    // given
    var input = this.getClass().getResourceAsStream(BASE_PATH + "instance_work_agent_no_lccn.json");
    var model = Rio.parse(input, "", RDFFormat.JSONLD);
  ...
  void mapBibframe2RdfToLd_shouldMapAgentTypeWithNoCurrentLccn(String rdfFile,
    ...
    throws IOException {
    // given
    var input = this.getClass().getResourceAsStream(BASE_PATH + rdfFile);
    var model = Rio.parse(input, "", RDFFormat.JSONLD);
    var creatorLabel = "Creator Agent";
    var contributorLabel = "Contributor Agent";
  ...
  void mapBibframe2RdfToLd_shouldHandleUncontrolledRoleLabels() throws IOException {
    // given
    var input = this.getClass().getResourceAsStream(BASE_PATH + "instance_work_agent_uncontrolled_role_label.json");
    var model = Rio.parse(input, "", RDFFormat.JSONLD);
  ...
  void mapBibframe2RdfToLd_shouldReturnMappedInstanceWithWorkWithAgents_withLccnAndUncontrolledRoles()
    ...
    var input = this.getClass().getResourceAsStream(BASE_PATH
      + "instance_work_agent_lccn_uncontrolled_role_label.json");
    var model = Rio.parse(input, "", RDFFormat.JSONLD);
  ...
  void mapBibframe2RdfToLd_shouldMapAllRolesFromSingleContribution() throws IOException {
    // given
    var input = this.getClass().getResourceAsStream(BASE_PATH
      + "instance_work_agent_multi_role_single_contribution.json");
    var model = Rio.parse(input, "", RDFFormat.JSONLD);
  ...
  @ParameterizedTest
  @ValueSource(strings = {
    "instance_work_agent_lccn.json",
    "instance_work_agent_no_lccn.json"
  })
  void mapLdToBibframe2Rdf_shouldReturnMappedRdfInstanceWithWorkWithAgents(String rdfFile) throws IOException {
    ...
    var expected = new String(this.getClass().getResourceAsStream(BASE_PATH + rdfFile).readAllBytes())
  ...
  void mapLdToBibframe2Rdf_shouldReturnWorkWithSameAgentAsCreatorAndContributorCorrectly() throws IOException {
    ...
    var expected = new String(this.getClass()
      .getResourceAsStream(BASE_PATH + "instance_work_agent_as_creator_and_contributor.json")
      .readAllBytes())
      .replaceAll("INSTANCE_ID", instance.getId().toString())
      .replaceAll("WORK_ID", work.getId().toString())
      .replaceAll("CREATOR_ID", "CREATOR_" + creator.getId().toString())
  ...
  static Stream<Arguments> contributionTypeScenarios() {
    return Stream.of(
      Arguments.of("instance_work_agent_single_primary_contribution.json", CREATOR, "n2021004098", AUTHOR),
      Arguments.of("instance_work_agent_single_contribution.json", CONTRIBUTOR, "n2021004092", ILLUSTRATOR)
    );
  }
  ...
  static Stream<Arguments> noLccnAgentTypeArgs() {
    return Stream.of(
      Arguments.of("instance_work_agent_no_lccn_person.json", PERSON),
      Arguments.of("instance_work_agent_no_lccn_family.json", FAMILY),
      Arguments.of("instance_work_agent_no_lccn_organization.json", ORGANIZATION),
      Arguments.of("instance_work_agent_no_lccn_jurisdiction.json", JURISDICTION),
      Arguments.of("instance_work_agent_no_lccn_meeting.json", MEETING)
    );
  }

  static Stream<Arguments> noLccnUncontrolledRoleAgentTypeArgs() {
    return Stream.of(
      Arguments.of("instance_work_agent_no_lccn_uncontrolled_role_person.json", PERSON),
      Arguments.of("instance_work_agent_no_lccn_uncontrolled_role_family.json", FAMILY),
      Arguments.of("instance_work_agent_no_lccn_uncontrolled_role_organization.json", ORGANIZATION),
      Arguments.of("instance_work_agent_no_lccn_uncontrolled_role_jurisdiction.json", JURISDICTION),
