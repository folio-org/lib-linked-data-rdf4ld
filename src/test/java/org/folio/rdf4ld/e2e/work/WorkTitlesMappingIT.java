...
class WorkTitlesMappingIT {
  ...
  @Test
  void mapBibframe2RdfToLd_shouldReturnMappedWorkWithTitles() throws IOException {
    // given
    var input = this.getClass().getResourceAsStream("/rdf/work/work_titles.json");
  ...
  @Test
  void mapLdToBibframe2Rdf_shouldReturnMappedRdfWorkWithTitles() throws IOException {
    // given
    ...
    var expected = new String(this.getClass().getResourceAsStream("/rdf/work/work_titles.json").readAllBytes())
