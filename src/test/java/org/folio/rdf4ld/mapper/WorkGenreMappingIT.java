...
class WorkGenreMappingIT {
  ...
  void mapBibframe2RdfToLd_shouldReturnMappedInstanceWithWorkWithGenreMock(String rdfFile) throws IOException {
    // given
    ...
    validateOutgoingEdge(instance, INSTANTIATES, Set.of(WORK, BOOKS), Map.of(), "", work ->
