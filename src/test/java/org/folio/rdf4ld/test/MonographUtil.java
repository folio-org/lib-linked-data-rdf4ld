...
public class MonographUtil {
  ...
  public static Resource getSampleInstanceResource(Long id, Resource linkedWork) {
    ...
    var instance = createResource(
      Map.ofEntries(
        ...
        entry(DIMENSIONS, List.of("20 cm", "5 litres")),
        ...
        entry(STATEMENT_OF_RESPONSIBILITY, List.of("statement of responsibility 1", "statement of responsibility 2")),
  ...
  private static Resource status(String prefix) {
    return createResource(
      Map.of(
  ...
  public static Resource providerEvent(String type, String code, String label) {
    return createResource(
      Map.of(
  ...
  private static Resource providerPlace(String code, String label) {
    return createResource(
      Map.of(
        CODE, List.of(code),
        LABEL, List.of(label),
