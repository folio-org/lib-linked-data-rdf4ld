...
public class CoreRdf2LdMapperImpl implements CoreRdf2LdMapper {
  ...
  @Override
  public Stream<org.eclipse.rdf4j.model.Resource> selectResourcesByTypes(Model model, Set<String> bfTypeSet) {
    return model.stream()
  ...
  private Set<Resource> mapEdgeTargets(Model model, ResourceMapping edgeMapping) {
    ...
    return selectResourcesByTypes(model, edgeMapping.getBfResourceDef().getTypeSet())
